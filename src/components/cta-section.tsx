...
export default function CTASection() {
  return (
    <section className="relative py-24 md:py-32 overflow-hidden">
      ...
      {/* Decorative gradient shapes outside the card */}
      <div className="absolute top-20 left-[10%] w-[300px] h-[300px] bg-[#0066FF]/[0.06] rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-20 right-[10%] w-[250px] h-[250px] bg-[#338AFF]/[0.05] rounded-full blur-[80px] pointer-events-none" />
      <div className="absolute top-1/2 left-[5%] -translate-y-1/2 w-[150px] h-[400px] bg-gradient-to-b from-[#0066FF]/[0.04] via-transparent to-[#0066FF]/[0.03] rounded-full blur-[60px] pointer-events-none" />
      <div className="absolute top-1/2 right-[5%] -translate-y-1/2 w-[150px] h-[400px] bg-gradient-to-b from-[#338AFF]/[0.03] via-transparent to-[#338AFF]/[0.04] rounded-full blur-[60px] pointer-events-none" />

      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Centered card */}
        <div className="relative bg-gradient-to-br from-[#0A1628] via-[#0d1f3a] to-[#0A1628] rounded-3xl shadow-2xl shadow-blue-900/20 p-8 sm:p-12 md:p-16 overflow-hidden">
          {/* Inner subtle glow */}
          <div className="absolute top-0 right-0 w-80 h-80 bg-[#0066FF]/[0.08] rounded-full blur-[100px] pointer-events-none" />
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#338AFF]/[0.06] rounded-full blur-[80px] pointer-events-none" />
