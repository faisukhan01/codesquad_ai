...
const BOT_REPLIES: Record<string, string> = {
  'our services':
    'We offer web development, mobile apps, UI/UX design, cloud infrastructure, and dedicated dev teams. Our engineers are experts in React, Next.js, Node.js, and more. Want me to connect you with a specialist?',
  'pricing info':
    'Our plans start from $2,500/mo for small projects and scale up for enterprise needs. We also offer flexible hourly engagements starting at $120/hr. Would you like a detailed quote?',
  'book a call':
    "I'd love to set that up! You can book a free 30-minute consultation directly on our calendar. Our team typically responds within 2 business hours.",
  'talk to human':
    'Transferring you to a team member now. Our average response time is under 2 minutes during business hours (9 AM - 6 PM EST).',
};
...
export default function LiveChat() {
  ...
  return (
    <div className="fixed bottom-5 right-3 sm:bottom-6 sm:right-6 z-[50] flex flex-col items-end gap-3">
        ...
        {isOpen && (
          ...
          >
            ...
            <div
              ...
              style={{
                background: 'linear-gradient(135deg, #0066FF 0%, #338AFF 50%, #1A7AFF 100%)',
              }}
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-white font-semibold text-[15px] leading-tight tracking-tight">
                    CodeSquad Support
                  </h3>
              ...
              {messages.map((msg) => (
                ...
                >
                  ...
                  <div className="max-w-[80%] sm:max-w-[78%] flex flex-col min-w-0">
                    ...
                    <span
                      className={`text-[10px] text-gray-400 mt-1 px-0.5 ${
                ...
                >
                  ...
                  <div className="bg-white rounded-2xl rounded-bl-lg px-4 py-2.5 shadow-[0_1px_4px_rgba(0,0,0,0.05)] border border-gray-200/50">
                    <div className="flex gap-1 items-center">
                      <span
                        className="w-1.5 h-1.5 bg-[#0066FF]/50 rounded-full animate-bounce"
            ...
            <div className="px-3.5 sm:px-4 pt-2 pb-3 border-t border-gray-100 bg-white shrink-0">
              ...
              <p className="text-center text-[10px] text-gray-300 mt-2 select-none pb-1">
                Powered by{' '}
                <span className="font-medium text-gray-400">CodeSquad</span>
              </p>
            </div>
          </motion.div>
        )}
      ...
      >
        {/* Breathing glow effect when closed */}
        {!isOpen && (
          <>
            <motion.span
